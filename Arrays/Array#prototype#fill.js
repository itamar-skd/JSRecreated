...
Array.prototype.fillRecreated = function(value, start = 0, end = this.length) {
...
let filledArr = arr.fillRecreated(0, 1, 3)
console.log(filledArr) // [ 1, 0, 0, 0, 10 ]

filledArr = arr.fillRecreated(0, 1)
console.log(filledArr) // [ 1, 0, 0, 0, 0 ]

filledArr = arr.fillRecreated(0, 0, 3)
console.log(filledArr) // [ 0, 0, 0, 8, 10 ]

filledArr = arr.fillRecreated(0)
